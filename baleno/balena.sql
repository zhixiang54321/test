drop database if exists balena;
create database balena charset=utf8;
set names utf8;
use balena;
...
insert into bn_user values(10,"vince",123456);
insert into bn_user values(20,"haha",456789);
create table balena_product(
	pid int primary key auto_increment,
	pname varchar(64),
	price float(8,2),
	pic varchar(32)
);
INSERT INTO balena_product VALUES
...
create table balena_cart(
	cid int primary key auto_increment,
	userId int
);
create table balena_cart_detail(
	did int primary key auto_increment,
	cartId int,
	productId int,
	count int
);
insert into balena_cart values(100,10);

insert into balena_cart_detail values(null,100,8,2);
insert into balena_cart_detail values(null,100,15,1);
insert into balena_cart_detail values(null,100,27,3);
/**订单信息表**/
CREATE TABLE balena_order(
  oid INT PRIMARY KEY AUTO_INCREMENT,
  rcvName VARCHAR(16),
  rcvAddr VARCHAR(64),
  rcvPhone VARCHAR(32),
  price FLOAT(10,2),
  payment INT,      #(支付方式1/2/3/4)
  orderTime BIGINT,
  status INT,       #(订单状态1/2/3/4)
  userId INT
);
INSERT INTO balena_order VALUES
(90000000, 'vince爸', '广州市天河区happy小区','13501234567','3800','1','1401234567890','1','10'),
(NULL, 'vince妈', '广州市天河区happy小区','13511234567','300','2','1411234567890','2','10'),
(NULL, 'vince哥', '广州市天河区happy小区','13521234567','800','3','1421234567890','3','10'),
(NULL, 'vince姐', '广州市天河区happy小区','13531234567','300','4','1431234567890','4','10'),
(NULL, 'vince奶', '广州市天河区happy小区','13541234567','5100','1','1441234567890','1','10'),
(NULL, 'vince爷', '广州市天河区happy小区','13551234567','3200','2','1451234567890','2','10');

/**订单详情表——保存订单中所购买的商品**/
CREATE TABLE balena_order_detail(
  did INT PRIMARY KEY AUTO_INCREMENT,
  orderId INT,
  productId INT,
  count INT
);
INSERT INTO balena_order_detail VALUES
(NULL,90000000,10, 2),
(NULL,90000000,15, 1),
(NULL,90000001,18, 3),
(NULL,90000002,11, 5),
...
/*抽奖记录表*/
create table balena_lottery(
	lid int primary key auto_increment,
	userId int,
	level int,
	lotteryTime bigint
);
insert into balena_lottery values(null,10,1,1401546278954);
insert into balena_lottery values(null,10,2,1411546278954);
insert into balena_lottery values(null,10,3,1409546278954);